 ...
 */
public class Median implements Subject {
    ...
    private static TestCase loadTestById(int id, boolean whitebox) {
        ...
        Path outputPath;
        if (whitebox) {
            inputPath = FileSystems.getDefault().getPath("data", "median-whitebox", id + ".in");
            outputPath = FileSystems.getDefault().getPath("data", "median-whitebox", id + ".out");
        } else {
            inputPath = FileSystems.getDefault().getPath("data", "median-blackbox", id + ".in");
            outputPath = FileSystems.getDefault().getPath("data", "median-blackbox", id + ".out");
        }
